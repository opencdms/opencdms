...
Topographic context classification code list.
...
.. tabs::
    .. tab:: Table definition
        ...
        Download the definition as a CSV file: :download:`csv <topographic_context.csv>`.

        .. csv-table:: Definition of the *topographic_context* table.
    ...
    .. tab:: Example data
        ...
        Download the example CSV file: :download:`csv <./examples/topographic_context.csv>`.

        .. csv-table:: Example data
           :file: ./examples/topographic_context.csv
           :header-rows: 1
           :quote: '
