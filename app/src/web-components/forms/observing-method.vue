...
export default defineComponent({
  ...
  setup() {
    ...
    const updateLinks = (updatedLinks) => {
      ...
      observingMethod.value.links = updatedLinks;
    }
    ...
    const createObservingMethod = async () => {
        let valueToSave = {};
        Object.assign(valueToSave,observingMethod.value);
        await observingMethodRepo.save(valueToSave);
        resetObservingMethod();
    };

    const resetObservingMethod = () => {
